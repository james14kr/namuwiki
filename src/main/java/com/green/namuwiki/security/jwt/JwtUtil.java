package com.green.namuwiki.security.jwt;
...
// JWT 토큰을 생성, 정보 읽기, 설정하는 기능을 모아놓은 클래스
@Component //객체 생성
public class JwtUtil {
  ...
  /**
   * 토큰 생성 메서드
   * @param username 회원이메일
   * @param role 권한
   * @param expirationTime 만료날짜및시간 1000 -> 1초
   * @return 위 정보가 담긴 토큰을 리턴
   */
  public String createJwt(String username, String role, long expirationTime, String memNickname) {
    return Jwts.builder()
